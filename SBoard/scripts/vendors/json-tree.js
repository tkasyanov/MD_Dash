    ...
    angular.module('json-tree', [])
        ...
        .directive('jsonTree', ['$compile', '$q', '$http', '$templateCache', 'jsonTreeConfig', function ($compile, $q, $http, $templateCache, jsonTreeConfig) {
            ...
            var template =
                ...
                '<span class="reset" ng-click="utils.resetNode(key)" ng-show="node.isHighEditLevel"> ~ </span>' +
                '<span class="remove" ng-click="utils.removeNode(key)" ng-show="node.isHighEditLevel">-</span>' +
        ...
        .directive('draggable', function ($document) {
            return {
                link: function (scope, element, attr) {
                    ...
                    if (scope.node && scope.node.dragElements)
